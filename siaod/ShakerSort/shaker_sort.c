...
int main(){
    ...
    printf("--------------------------------------------------------------\n");
    printf("|      |     Mф+Cф пузырьковой    |      Mф+Cф шейкерной     |\n");
    ...
    for (int idx = 0; idx < 5; idx++) {
        ...
        long MC_ub_B, MC_sl_B, MC_voz_B;
        long MC_ub_S, MC_sl_S, MC_voz_S;  
        ...
        printf("| %4d | %6ld | %6ld | %6ld | %6ld | %6ld | %6ld |\n", 
               n, MC_ub_B, MC_sl_B, MC_voz_B,MC_ub_S,MC_sl_S,MC_voz_S);
        printf("|------------------------------------------------------------|\n");
        free(arr);
    }
    printf("ShakerSort сильно зависит от исходной упорядоченности массива.\n");
